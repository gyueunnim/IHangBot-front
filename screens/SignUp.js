    ...
    <View style={signUpStyle.container}>
      <ScrollView>
        <View>
          ...
          <TextInput placeholder="아이의 이름을 입력하세요" onChangeText={(value) => setName(value)} style={commonStyle.form} />
          ...
          <TextInput placeholder="아이디를 입력하세요" onChangeText={(value) => setId(value)} style={commonStyle.form} />

          <View style={signUpStyle.fx}>
            <Text style={commonStyle.title}>비밀번호 </Text>
            <Text style={signUpStyle.highlight}>*</Text>
          </View>
          <TextInput placeholder="비밀번호를 입력하세요" onChangeText={(value) => setPw(value)} secureTextEntry={true} style={commonStyle.form} />
        ...
        <View>
          ...
          <Text style={(name !== '' && id !== '' && pw !== '' && pwCheck !== '' && age !== '') ? commonStyle.active : commonStyle.btn}>회원가입</Text>
            {
            signUpErr === false ? null
            : <Text style={commonStyle.error}>회원가입에 실패하였습니다 - 다시 시도해주세요</Text> 
            }
          </TouchableOpacity>
        </View>
      </ScrollView>
